...
const topTeamMembers: TeamMember[] = [
  ...
  { 
    ...
    description: [
      "Nick is the mastermind behind the world's undisputed largest dating photography empire, a company generating millions in revenue. His photographers are strategically stationed across the US, each handpicked for their ability to capture perfection—because, naturally, Nick settles for nothing less.",
