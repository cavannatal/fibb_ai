  ...
  return (
    <section className="px-4 sm:px-6 py-2"> {/* Added horizontal padding */}
      <div className="max-w-3xl mx-auto"> {/* Reduced max-width for better content width control */}
        ...
        >
          <p className="text-base sm:text-lg leading-relaxed mb-6" style={{ fontFamily: 'Font1, sans-serif' }}>
          ...
          <p className="text-base sm:text-lg leading-relaxed" style={{ fontFamily: 'Font1, sans-serif' }}>
